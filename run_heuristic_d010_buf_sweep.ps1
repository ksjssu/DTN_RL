...
foreach ($buf in $buffers) {
    ...
    $scenario = "scenario_heuristic_d010_buf{0}_100k.txt" -f $labelValue
    Write-Host ("[heuristic delta0.1] buffer={0} :: running {1}" -f $bufferLabel, $scenario) -ForegroundColor Yellow
