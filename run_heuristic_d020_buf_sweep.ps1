...
foreach ($buf in $buffers) {
    ...
    $scenario = "scenario_heuristic_d020_buf{0}_100k.txt" -f $labelValue
    Write-Host ("[heuristic delta0.2] buffer={0} :: running {1}" -f $bufferLabel, $scenario) -ForegroundColor Yellow
